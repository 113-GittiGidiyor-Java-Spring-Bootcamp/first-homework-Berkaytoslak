...
public class InstructorService implements CrudRepository<Instructor>, InstructorRepository {
    ...
    public void deleteFromDatabase(Instructor instructor) {
        ...
        try {
            entityManager.getTransaction().begin();
            Instructor foundInstructor = entityManager.createQuery("from Instructor i where i.telNo =: telNo", Instructor.class).setParameter("telNo",instructor.getTelNo()).getSingleResult();
    ...
    public void updateOnDatabase(Instructor instructor, int id) {
        ...
        try {
            ...
            foundInstructor.setTelNo(instructor.getTelNo());
